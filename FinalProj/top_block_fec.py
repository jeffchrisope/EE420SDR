...
# Title: Top Block Fec
# Generated: Mon Jun 18 12:38:42 2018
##################################################
...
class top_block_fec(gr.top_block, Qt.QWidget):

    def __init__(self, frame_sz_bytes=30):
        gr.top_block.__init__(self, "Top Block Fec")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Top Block Fec")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "top_block_fec")
...
def main(top_block_cls=top_block_fec, options=None):
    if options is None:
